...
if status.get('starting_node'):
    ...
    result = client.select_starting_node("Las Vegas, NV")
    print(result)
...
# ---- EDIT THESE ----
SOURCE = "Honolulu, HI"
TARGET = "Sydney, Australia"  # replace with a D2 edge you can claim

attack = conquer_edge_with_d4_n3(client, SOURCE, TARGET)
...
conquer_edge_with_d5_n5(client, SOURCE, TARGET, verbose_qasm_tail=0)
